...
static char chartable[] = {
        ...
        ALPHA,  ALPHA,  ALPHA,  XREGOP,   /* u v w x    >A4->A7 */
        ...
        ALPHA,  ALPHA,  ALPHA,  XREGOP,   /* U V W X    >E4->E7 */
        ...
        DOLLAR, SPECIAL,SPECIAL,SPECIAL,  /* $ % & '    >24->27 */
        OPERAT, OPERAT, PCSYM,  PLUS,     /* ( ) * +    >28->2B */
        ...
        SPECIAL,SPECIAL,SPECIAL,SPECIAL,  /* < = > ?    >3C->3F */
        ...
        XREGOP, ALPHA,  ALPHA,  OPERAT,   /* X Y Z [    >58->5B */
        ...
        XREGOP, ALPHA,  ALPHA,  OPERAT,   /* x y z {    >78->7B */
...
static short int S1[] = {
        ...
        ENTRY(XREGOP,3,EAT_ACTION|MOVE_ACTION),
